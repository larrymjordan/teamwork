<?php
 ...
 return array(
  ...
  "edit_member_title"         => "Update your team member data",
  ...
  "edit_member_information"   => "Update whatever member data using the respective field. Every change made wil be automaticly reflected in the dashboard",
